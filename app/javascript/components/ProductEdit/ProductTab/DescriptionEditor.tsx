...
export const DescriptionEditor = ({
  ...
  const editor = useRichTextEditor({
    id: uid,
    className:
      "textarea px-4 py-3 border border-border rounded block w-full bg-filled text-foreground placeholder:text-muted focus-within:outline-2 focus-within:outline-offset-0 focus-within:outline-accent",
  ...
  return (
    <FormFieldset>
      <FormLabel htmlFor={uid}>Description</FormLabel>
