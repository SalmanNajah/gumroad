...
export const Covers = ({
  ...
  return (
    <figure className={classNames("group relative col-span-full bg-[url('~images/placeholders/product-cover.png')] bg-cover border-b border-border rounded-t overflow-hidden", className)} aria-label="Product preview">
      {closeButton}
